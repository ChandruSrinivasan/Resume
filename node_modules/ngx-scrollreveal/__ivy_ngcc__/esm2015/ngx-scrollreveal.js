...
NgsRevealConfig.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: NgsRevealConfig, factory: NgsRevealConfig.ɵfac, providedIn: 'root' });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgsRevealConfig, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
NgsRevealService.ɵfac = function NgsRevealService_Factory(t) { return new (t || NgsRevealService)(ɵngcc0.ɵɵinject(NgsRevealConfig), ɵngcc0.ɵɵinject(WindowService)); };
NgsRevealService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: NgsRevealService, factory: NgsRevealService.ɵfac, providedIn: 'root' });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgsRevealService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
NgsRevealDirective.ɵfac = function NgsRevealDirective_Factory(t) { return new (t || NgsRevealDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(NgsRevealService)); };
NgsRevealDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: NgsRevealDirective, selectors: [["", "ngsReveal", ""]], hostVars: 2, hostBindings: function NgsRevealDirective_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵstyleProp("visibility", ctx.visibility);
    } }, inputs: { _config: ["ngsReveal", "_config"] }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgsRevealDirective, [{
        type: Directive,
        args: [{
                selector: '[ngsReveal]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: NgsRevealService }]; }, { visibility: [{
            type: HostBinding,
...
NgsRevealSetDirective.ɵfac = function NgsRevealSetDirective_Factory(t) { return new (t || NgsRevealSetDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(NgsRevealService)); };
NgsRevealSetDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: NgsRevealSetDirective, selectors: [["", "ngsRevealSet", ""]], inputs: { _config: ["ngsRevealSet", "_config"], ngsSelector: "ngsSelector", ngsInterval: "ngsInterval", ngsSync: "ngsSync" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature, ɵngcc0.ɵɵNgOnChangesFeature] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgsRevealSetDirective, [{
        type: Directive,
        args: [{
                selector: '[ngsRevealSet]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: NgsRevealService }]; }, { _config: [{
            type: Input,
            args: ['ngsRevealSet']
        }], ngsSelector: [{
            type: Input
...
NgsRevealModule.ɵfac = function NgsRevealModule_Factory(t) { return new (t || NgsRevealModule)(); };
NgsRevealModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: NgsRevealModule });
NgsRevealModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[
            CommonModule
        ]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgsRevealModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgsRevealModule, { declarations: function () { return [NgsRevealDirective, NgsRevealSetDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [NgsRevealDirective, NgsRevealSetDirective]; } }); })();
